...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/wheels-tube/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'dist/wheels-tube/browser'), 'index.html')
    )
    .toString();
    ...
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          image:
            'https://www.healing.tube/assets/images/default-profile.jpg',
        ...
        if (
          ...
          const talent = {
            ...
            image: post?.thumbfilename || post?.metaimage || post?.imageUrl || 'https://www.healing.tube/assets/images/default-profile.jpg',
          };
          seo.title = talent.name;
          seo.description = strip_html_tags(talent.description);
          seo.image = talent.image;
